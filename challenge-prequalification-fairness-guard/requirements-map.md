...
- Verifies that prequalification rounds use published criteria, unique criterion identifiers, nonnegative weights, valid weight totals, and valid 0-100 pass thresholds.
