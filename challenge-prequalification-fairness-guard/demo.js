...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="1280" height="720" viewBox="0 0 1280 720">
  ...
  <text x="96" y="380" fill="#ffffff" font-family="Arial, sans-serif" font-size="24">Checks: unique criteria, reviewer quorum, thresholds, anonymity, conflicts, appeals</text>
