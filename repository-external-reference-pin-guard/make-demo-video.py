...
for index, (status, color, description) in enumerate(cards):
    y = 138 + index * 134
    draw.rounded_rectangle((58, y, 1222, y + 96), radius=8, outline="#cbd5e1", width=2, fill="#f8fafc")
    draw.ellipse((88, y + 29, 126, y + 67), fill=color)
    draw.text((150, y + 22), status, fill="#111827", font=body_font)
    for line_index, line in enumerate(textwrap.wrap(description, width=78)):
        draw.text((150, y + 55 + line_index * 26), line, fill="#475569", font=small_font)
