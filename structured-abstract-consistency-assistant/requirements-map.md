...
| Claims vs. evidence alignment | Compares abstract claims against method design, target-specific sample sizes, comma-formatted manuscript counts, primary endpoint, bidirectional result direction, conclusion benefit drift, lower/shorter/faster benefit wording, negative/no-effect-result drift, improved-result/worse-wording drift, accurate adverse-outcome wording, and uncertainty. |
