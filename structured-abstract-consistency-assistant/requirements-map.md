...
| Claims vs. evidence alignment | Compares abstract claims against method design, target-specific sample sizes, comma-formatted manuscript counts, primary endpoint, result direction, conclusion benefit drift, lower/shorter/faster benefit wording, negative/no-effect-result drift, and uncertainty. |
