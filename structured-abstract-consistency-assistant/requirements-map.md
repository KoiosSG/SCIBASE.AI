...
| Claims vs. evidence alignment | Compares abstract claims against method design, target-specific sample sizes, primary endpoint, result direction, negative-result drift, and uncertainty. |
