...
| Claims vs. evidence alignment | Compares abstract claims against method design, target-specific sample sizes, comma-formatted manuscript counts, primary endpoint, result direction, conclusion benefit drift, negative-result drift, and uncertainty. |
