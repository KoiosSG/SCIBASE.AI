...
The guard detects private research project context, restricted dataset references, collaborator identifiers, grant-sensitive phrases, and unsafe provider metadata. Safe receipts remain deliverable, while unsafe receipts are held for finance review with redacted replacement line items and deterministic audit evidence.
