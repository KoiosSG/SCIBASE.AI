...
The guard detects private research project context, restricted dataset references, collaborator identifiers, grant-sensitive phrases, unsafe receipt identifiers, unsafe line-item fields, and unsafe provider metadata, including nested provider metadata values. Safe receipts remain deliverable, while unsafe receipts are held for finance review with redacted replacement identifiers, replacement line items, and deterministic audit evidence.
