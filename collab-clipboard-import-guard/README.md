...
- malformed import payloads that do not provide a valid block list
...
Generated packets include unsafe clipboard, partner-review, trusted-attestation, placeholder-attestation, unsupported-channel, malformed-block-list, private source-origin, lowercase Windows path, forward-slash Windows path, and clean trusted import examples.
