...
Generated packets include unsafe clipboard, partner-review, trusted-attestation, placeholder-attestation, unsupported-channel, private source-origin, lowercase Windows path, forward-slash Windows path, and clean trusted import examples.
