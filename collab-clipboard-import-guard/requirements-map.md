...
| Real-time collaboration trust boundary | Stages imports with missing source trust metadata or blank partner attestations for curator review before collaborative insertion, and quarantines source-origin metadata that exposes local/private paths. |
