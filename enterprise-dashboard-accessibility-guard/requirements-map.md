...
| Contributor and usage analytics | Checks that critical and noncritical metrics are perceivable, use valid contrast evidence, are labeled, keyboard reachable with visible focus indicators, and safe for nonvisual users. |
