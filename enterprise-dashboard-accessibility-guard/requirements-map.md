...
| Enterprise governance | Detects private-data leakage in screen-reader labels, table summaries, and export summaries before dashboard or export surfaces are published, and blocks malformed dashboard component evidence instead of crashing before audit packet generation. |
